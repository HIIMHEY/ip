...
description: Use when asked to show, review, share, or inspect Git changes visually; compare revisions, branches, commits, or the worktree; or create a self-contained HTML diff.
---
...
4. Run the bundled generator from the repository root:
   ...
   On systems where `py` is unavailable, use `python3` or `python`.
